...
jest.mock('./modules/HeroBanner', () => () => <div data-testid="hero-banner">Hero Banner</div>);
jest.mock('./modules/InstructionAccordion', () => () => <div data-testid="instruction-accordion">Instructions</div>);
jest.mock('./modules/QueryFields', () => ({ onQueriesChange }: any) => (
  <div data-testid="query-fields">Query Fields</div>
));
jest.mock('./modules/SearchForm', () => ({ queries, setResponse, onCheapestItemsChange, onStepComplete }: any) => (
  <div data-testid="search-form">Search Form</div>
));
jest.mock('./modules/Results', () => ({ response }: any) => <div data-testid="results">Results</div>);
jest.mock('./modules/CheapestItem', () => ({ items }: any) => <div data-testid="cheapest-item">Cheapest Item</div>);
