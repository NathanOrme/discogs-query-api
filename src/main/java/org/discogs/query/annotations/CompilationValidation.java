...
@Constraint(validatedBy = CompilationValidator.class)
public @interface CompilationValidation {
     ...
     * This can be used to apply different sets of validation
    ...
    /**
     * Payload that can carry additional metadata about the annotation.
     * This is typically used by validation clients
     * to carry additional information about the validation constraint.
     *
