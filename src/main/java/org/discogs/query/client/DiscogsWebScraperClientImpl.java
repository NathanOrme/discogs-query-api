...
public class DiscogsWebScraperClientImpl implements DiscogsWebScraperClient {
    ...
    /**
     * Scrapes the Discogs Marketplace website for listings of a given release ID
     * and filters them by country (United Kingdom).
     *
    ...
    /**
     * Processes a single listing element and returns a DiscogsWebsiteResult if the listing
     * meets the criteria (i.e. it ships from the United Kingdom and contains seller info).
     *
