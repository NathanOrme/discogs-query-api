 ...
 *
 * <p>This class provides a Spring configuration to customize the default behavior of Jackson's
 * {@link ObjectMapper}. Specifically, it registers custom deserializers for the {@link
 * DiscogsTypes} and {@link DiscogsFormats} enums, allowing proper deserialization of enum values
 * from JSON strings.
 *
 * <p>The custom deserializers, {@link DiscogsTypesDeserializer} and {@link
 * DiscogsFormatsDeserializer}, are added to a {@link SimpleModule}, which is then registered with
 * the {@link ObjectMapper}. This setup ensures that any JSON processing involving {@link
 * DiscogsTypes} and {@link DiscogsFormats} will use the specified deserializers to convert JSON
