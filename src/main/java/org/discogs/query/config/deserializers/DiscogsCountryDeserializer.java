...
public class DiscogsCountryDeserializer extends JsonDeserializer<DiscogCountries> {
     ...
     * match it with one of the {@link DiscogCountries} enum
     * constants using the {@link DiscogCountries#valueOf(String)}
     ...
     * @return the corresponding {@link DiscogCountries} enum constant,
