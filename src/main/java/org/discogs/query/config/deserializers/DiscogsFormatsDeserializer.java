 ...
 *
 * <p>This class is responsible for deserializing JSON representation of {@link DiscogsFormats} enum
 * values during the deserialization process. It converts a JSON string into the corresponding
 * {@link DiscogsFormats} enum constant.
 *
...
public class DiscogsFormatsDeserializer extends JsonDeserializer<DiscogsFormats> {
     ...
     * attempts to match it with one of the {@link DiscogsFormats} enum constants using the {@link
     * DiscogsFormats#valueOf(String)} method. If the JSON string is null, empty, or does not match
     ...
     * DiscogsFormats#UNKNOWN}.
     *
     * @param jp   the JSON parser used to read the JSON content
     * @param ctxt the deserialization context
     * @return the corresponding {@link DiscogsFormats} enum constant, or {@code null} if no match is
     * found
