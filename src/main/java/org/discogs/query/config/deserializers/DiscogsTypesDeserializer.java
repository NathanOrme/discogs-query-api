...
public class DiscogsTypesDeserializer extends JsonDeserializer<DiscogsTypes> {
     ...
     * match it with one of the {@link DiscogsTypes} enum constants using the {@link DiscogsTypes#valueOf(String)}
     ...
     * @return the corresponding {@link DiscogsTypes} enum constant, or {@code null} if no match is found
