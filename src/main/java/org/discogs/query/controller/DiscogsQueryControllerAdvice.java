...
public class DiscogsQueryControllerAdvice {
  ...
  /**
   * Handles CallNotPermittedException from Resilience4j Circuit Breaker. Maps to HTTP 503 Service
   * Unavailable with a structured error response.
   *
  ...
  /**
   * Handles HttpClientErrorException for client-side errors. Maps to appropriate HTTP status codes
   * based on the exception details.
   *
  ...
  /**
   * Handles HttpServerErrorException for server-side errors. Maps to HTTP 502 Bad Gateway or other
  ...
  /**
   * Handles ResourceAccessException for connection timeouts or unavailable services. Maps to HTTP
   * 504 Gateway Timeout with a structured error response.
   *
  ...
  /**
   * Handles validation exceptions for invalid request parameters. Maps to HTTP 400 Bad Request with
  ...
  /**
   * Handles HttpRequestMethodNotSupportedException for unsupported HTTP methods. Maps to HTTP 405
   * Method Not Allowed with a structured error response.
   *
  ...
  /**
   * Handles Discogs-specific exceptions related to marketplace and search operations. Maps to HTTP
   * 500 Internal Server Error with a structured error response.
   *
  ...
  /**
   * Handles DiscogsSearchException for search-related errors. Maps to HTTP 500 Internal Server
   * Error with a structured error response.
   *
  ...
  /**
   * Handles NoMarketplaceListingsException when no marketplace listings are found. Maps to HTTP 404
   * Not Found with a structured error response.
   *
  ...
  /**
   * Handles TimeoutException for request processing timeouts. Maps to HTTP 408 Request Timeout with
   * a structured error response.
   *
  ...
  /**
   * Handles IOException for I/O operation failures. Maps to HTTP 500 Internal Server Error with a
  ...
  /**
   * Handles RuntimeException for general runtime errors. Maps to HTTP 500 Internal Server Error
  ...
  /**
   * Handles generic exceptions that are not specifically handled by other methods. Maps to HTTP 500
   * Internal Server Error with a structured error response.
   *
