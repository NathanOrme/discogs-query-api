...
/**
 * Represents a Discogs release, which contains detailed information about a specific music release
 * including title, artists, formats, genres, and more.
 */
@Getter
@Setter
@Builder
...
public class DiscogsRelease {
  ...
  /**
   * List of extra artists involved in the release. These could be additional performers, producers,
