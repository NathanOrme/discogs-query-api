...
/**
 * Represents an extra artist involved in a release. These could be
 * additional performers, producers, or other contributors not considered
 * the main artist(s).
 */
@Data
@Builder
...
public class ExtraArtist {
    ...
    /**
     * The artist name variation (ANV) used on the release. This could be
     * an alternate spelling, alias, or pseudonym.
     */
    private String anv;
    ...
    /**
     * The joining phrase or term, if the artist is part of a group
     * (e.g., "feat.", "vs", etc.).
     */
    private String join;
