...
/**
 * Helper class for making HTTP connections using Jsoup.
 * This component simplifies the process of fetching HTML content from a URL.
 */
@Component
public class JsoupHelper {

    /**
     * Connects to the specified URL and retrieves the HTML content as a {@link Document}.
     * This method allows the inclusion of custom headers in the request.
     *
