...
/**
 * Service for batch processing marketplace checks to optimize API calls. This service replaces N+1
 * individual marketplace calls with efficient batch operations.
 */
public interface BatchMarketplaceService {

  /**
   * Filters entries that have UK marketplace listings using batch processing. This method reduces N
   * individual API calls to a single batch operation.
   *
  ...
  /**
   * Retrieves marketplace availability for multiple release IDs in a batch. Deduplicates release
