 ...
 *
 * <p>This interface defines methods for executing actions with retry logic.
 */
public interface RetryService {
     ...
     *
     * <p>This method retries the action if it fails, up to a maximum number of attempts.
     *
