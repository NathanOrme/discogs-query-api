 ...
 * <p>
 * This package provides abstractions for various services related to
 * querying and interacting
 * with the Discogs API. The interfaces define methods for executing HTTP
 * requests, handling
 * retries, and managing rate limits, enabling flexible and reusable
 * implementations for
 ...
 *     Defines methods for managing rate limits and ensuring compliance with
 *     API quotas.</li>
 *     <li>{@link org.discogs.query.interfaces.RetryService} -
 *     Defines methods for executing actions with retry logic in case of
 *     failure.</li>
