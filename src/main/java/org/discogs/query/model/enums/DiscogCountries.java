...
/**
 * Enum representing a list of countries in the Discogs database. Each enum constant corresponds to
 * a country and is associated with a string value that represents the country's name.
 */
@Getter
@ToString
...
public enum DiscogCountries {
   ...
   *
   * <p>If the country string does not match any defined constant, {@link #UNKNOWN} is returned.
   *
   * @param country the country string to match
   * @return the {@link DiscogCountries} constant corresponding to the country string, or {@link
