 ...
 *
 * <p>This enum provides predefined constants for various resource types, such as releases, masters,
 * artists, and labels. Each constant is associated with a type string that represents its name in
 * the Discogs API.
 *
 * <p>The available types are:
 *
 * <ul>
 *   <li>{@link #RELEASE} - Represents a "release" resource type.
 *   <li>{@link #MASTER} - Represents a "master" resource type.
 *   <li>{@link #ARTIST} - Represents an "artist" resource type.
 *   <li>{@link #LABEL} - Represents a "label" resource type.
 *   <li>{@link #UNKNOWN} - Represents an unknown or unspecified type.
 * </ul>
 *
 * <p>The {@link #UNKNOWN} type is used as a default when the provided type string does not match
 * any of the defined constants.
 */
@Getter
