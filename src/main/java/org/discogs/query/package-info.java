/**
 * Contains the core components of the Discogs Query application.
 * <p>
 * This package serves as the main entry point for the application and includes various sub-packages that define the core
 * functionality and structure of the application. It integrates components related to querying the Discogs API, handling
 * responses, and managing data flow throughout the application. Key areas covered in this package include:
 * <ul>
