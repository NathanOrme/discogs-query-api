...
public class BatchMarketplaceServiceImpl implements BatchMarketplaceService {
  ...
  public BatchMarketplaceServiceImpl(
      DiscogsWebScraperClient discogsWebScraperClient,
      @Qualifier("discogsScraperExecutor") Executor scraperExecutor) {
    this.discogsWebScraperClient = discogsWebScraperClient;
