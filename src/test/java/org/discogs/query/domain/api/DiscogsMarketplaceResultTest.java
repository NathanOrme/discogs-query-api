...
class DiscogsMarketplaceResultTest {
    ...
    @Test
    void testBuilder() {
        DiscogsLowestPriceResult lowestPrice =
                DiscogsLowestPriceResult.builder().currency("GBP").value(12.50f).build();

        DiscogsMarketplaceResult result =
                DiscogsMarketplaceResult.builder().result(lowestPrice).numberForSale(20).build();
