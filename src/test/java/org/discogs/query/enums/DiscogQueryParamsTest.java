...
class DiscogQueryParamsTest {
    ...
    void testEnumValues() {
        ...
        assertEquals("format", format.getQueryType(), "The queryType for FORMAT should be 'format'");
        assertEquals("artist", artist.getQueryType(), "The queryType for ARTIST should be 'artist'");
