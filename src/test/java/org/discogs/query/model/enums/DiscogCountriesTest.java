 ...
 * <p>
 * This class tests the functionality of the {@link DiscogCountries#fromString(String)} method,
 * ensuring that it correctly returns the expected enum constants based on input strings.
 */
class DiscogCountriesTest {

    /**
     * Test to ensure that the correct {@link DiscogCountries} constant is returned
     * for each valid country string.
     */
    @Test
    ...
    /**
     * Test to ensure that {@link DiscogCountries#UNKNOWN} is returned
     * when an unknown or empty country string is provided.
     */
    @Test
    ...
    /**
     * Test to ensure that the {@link DiscogCountries#fromString(String)} method
     * is case-insensitive.
     */
    @Test
