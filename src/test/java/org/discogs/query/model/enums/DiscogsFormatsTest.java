 ...
 * <p>
 * This class tests the functionality of the {@link DiscogsFormats#fromString(String)} method,
 * ensuring that it correctly returns the expected enum constants based on input strings.
 */
class DiscogsFormatsTest {

    /**
     * Test to ensure that the correct {@link DiscogsFormats} constant is returned
     * for each valid format string.
     */
    @Test
    ...
    /**
     * Test to ensure that {@link DiscogsFormats#UNKNOWN} is returned
     * when an unknown or empty format string is provided.
     */
    @Test
    ...
    /**
     * Test to ensure that the {@link DiscogsFormats#fromString(String)} method
     * is case-insensitive.
     */
    @Test
