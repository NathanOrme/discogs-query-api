 ...
 * <p>
 * This class tests the functionality of the {@link DiscogsTypes#fromString(String)} method,
 * ensuring that it correctly returns the expected enum constants based on input strings.
 */
class DiscogsTypesTest {

    /**
     * Test to ensure that the correct {@link DiscogsTypes} constant is returned
     * for each valid type string.
     */
    @Test
    ...
    /**
     * Test to ensure that {@link DiscogsTypes#UNKNOWN} is returned
     * when an unknown or empty type string is provided.
     */
    @Test
    ...
    /**
     * Test to ensure that the {@link DiscogsTypes#fromString(String)} method
     * is case-insensitive.
     */
    @Test
