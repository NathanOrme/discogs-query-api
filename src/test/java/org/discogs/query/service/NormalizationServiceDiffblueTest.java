...
class NormalizationServiceDiffblueTest {
     ...
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    @Test
    ...
    void testNormalizeString() {
        ...
        assertEquals("p{InCombiningDiacriticalMarks} p{InCombiningDiacriticalMarks}",
                normalizationService.normalizeString("̀\\p{InCombiningDiacriticalMarks}\\p" +
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code 42 p{InCombiningDiacriticalMarks}}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturn42PInCombiningDiacriticalMarks() {
        // Arrange, Act and Assert
        assertEquals("42 p{InCombiningDiacriticalMarks}",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code Input p{InCombiningDiacriticalMarks}}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturnInputPInCombiningDiacriticalMarks() {
        // Arrange, Act and Assert
        assertEquals("Input p{InCombiningDiacriticalMarks}",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code p{InCombiningDiacriticalMarks}42}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturnPInCombiningDiacriticalMarks42() {
        // Arrange, Act and Assert
        assertEquals("p{InCombiningDiacriticalMarks}42",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code p{InCombiningDiacriticalMarks}Input}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturnPInCombiningDiacriticalMarksInput() {
        // Arrange, Act and Assert
        assertEquals("p{InCombiningDiacriticalMarks}Input",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code p{InCombiningDiacriticalMarks} s+}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturnPInCombiningDiacriticalMarksS() {
        // Arrange, Act and Assert
        assertEquals("p{InCombiningDiacriticalMarks} s+",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>Then return {@code s+ p{InCombiningDiacriticalMarks}}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
    ...
    void testNormalizeString_thenReturnSPInCombiningDiacriticalMarks() {
        // Arrange, Act and Assert
        assertEquals("s+ p{InCombiningDiacriticalMarks}",
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>When {@code ̀42\s+}.</li>
     *   <li>Then return {@code 42 s+}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>When {@code ̀Input\s+}.</li>
     *   <li>Then return {@code Input s+}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>When {@code ̀\p{InCombiningDiacriticalMarks}}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
     ...
     * Test {@link NormalizationService#normalizeString(String)}.
     * <ul>
     *   <li>When {@code ̀\s+Input}.</li>
     *   <li>Then return {@code s+Input}.</li>
     * </ul>
     * <p>
     * Method under test: {@link NormalizationService#normalizeString(String)}
     */
     ...
     * <p>
     * Method under test:
     * {@link NormalizationService#normalizeQuery(DiscogsQueryDTO)}
     */
    @Test
    @DisplayName("Test normalizeQuery(DiscogsQueryDTO)")
    void testNormalizeQuery() {
        // Arrange
        DiscogsQueryDTO query = new DiscogsQueryDTO("Artist", "Album", "Track", "Dr", "Format", DiscogCountries.UK,
    ...
    void testNormalizeQuery2() {
        // Arrange
        DiscogsQueryDTO query = new DiscogsQueryDTO(null, "Album", "Track", "Dr", "Format", DiscogCountries.UK,
                DiscogsTypes.RELEASE, "Barcode");
     ...
     * Test {@link NormalizationService#normalizeQuery(DiscogsQueryDTO)}.
     * <ul>
     *   <li>Then return artist is empty string.</li>
     * </ul>
     * <p>
     * Method under test:
     * {@link NormalizationService#normalizeQuery(DiscogsQueryDTO)}
    ...
    void testNormalizeQuery_thenReturnArtistIsEmptyString() {
        // Arrange and Act
        DiscogsQueryDTO actualNormalizeQueryResult = normalizationService.normalizeQuery(new DiscogsQueryDTO("̀",
                "Album",
                "Track", "Dr", "Format", DiscogCountries.UK, DiscogsTypes.RELEASE, "Barcode"));
